...
export default function MainPage() {
  ...
  const handleMaxResultsChange = (maxResults: 2 | 5 | 10) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex font-sf">
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className={`${sidebarCollapsed ? 'hidden' : 'block'}`}>
              ...
              <p className="text-sm text-slate-600 font-medium">Research Assistant</p>
            </div>
            <button
              onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
              className="p-2 rounded-lg bg-white/70 border border-slate-200/60 hover:bg-white/90 transition-colors shadow-sm backdrop-blur-sm"
            >
          ...
          {!sidebarCollapsed ? (
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold py-3 px-4 rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-blue-500/25"
            >
            ...
            <button
              onClick={handleNewSpace}
              className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold py-3 px-2 rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 flex items-center justify-center shadow-lg shadow-blue-500/25"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
              </svg>
                ...
                <div className="space-y-3 flex flex-col items-center">
                  ...
                  <div className="space-y-3 w-full max-w-3xl">
                    <textarea
                      ...
                      placeholder="Ask me anything about research, papers, or search for new papers..."
                            ...
                            <div className="absolute top-full left-0 mt-1 bg-white rounded-lg border border-slate-200 p-2 z-10 shadow-lg">
                              {[2, 5, 10].map((num) => (
                                <button
                                  key={num}
                                  onClick={() => {
                                    handleMaxResultsChange(num as 2 | 5 | 10);
      ...
      {/* User Profile Popup */}
      {showUserProfilePopup && !sidebarCollapsed && (
        <div className="absolute bottom-20 left-6 right-6 z-50 max-w-[280px]">
